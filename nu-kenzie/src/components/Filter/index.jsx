    ...
    return(
        <div className="filters flex justify-between items-center">
            ...
            <div className="btnsFilter flex gap3">
                <Button setStart={filterAll} text="Todos" classes="btnHeader btn2 font4"/>
                <Button setStart={filterEntry} text="Entradas" classes="btnHeader btn2 font4 text-grey1"/>
                <Button setStart={filterExit}text="Despesas" classes="btnHeader btn2 font4 text-grey1"/>
            </div>
        </div>
    )
}